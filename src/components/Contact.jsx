...
const Contact = () => {
  ...
  return (
    <div className='container md:mx-48 mx-6 mt-36'>
      <h1 className='text-4xl md:text-[65px] text-blue-600 font-bold mb-24'>Request a Demo</h1>

      <h3 className='text-2xl md:text-xl font-semibold md:w-1/3 mb-16'>Schedule a demo with one of our product consultants.</h3>
      ...
      <form action="" className='md:w-2/3 grid md:grid-cols-2 '>
        ...
        <div className="md:my-16 mt-5  mb-16  mr-20 flex">
