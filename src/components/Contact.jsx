...
const Contact = () => {
  return (
    <div className='container mx-48 mt-36'>
      <h1 className='text-blue-600 font-bold text-6xl mb-24'>Request a Demo</h1>

      <h2 className='text-3xl font-semibold w-1/3 mb-16'>Schedule a demo with one of our product consultants.</h2>

      <form action="" className='w-2/3 grid grid-cols-2 '>
